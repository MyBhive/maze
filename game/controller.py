...
"""Module to import all the classes and
...
class Controller:
    ...
    def __init__(self):
        """Initialize all the classes and themain data needed"""
        # calling classes
    ...
    def win_or_loose(self):
        ...
        When Mc Gyver x,y position is equal to
        the guardian x,y position:
    ...
    def loop(self):
        ...
        # instantiate pygame loop to run correctly
        # the game and close it easily with the exit cross if wanted
        launched = True
        while launched:
            self.lab.show_maze()
            ...
            if (self.player.pos_x, self.player.pos_y) == (self.guardian.pos_x,
                ...
                self.win_or_loose()
            # pick up the items,
            # put them in the inventory and delete their old position
            self.retrieve_items()
